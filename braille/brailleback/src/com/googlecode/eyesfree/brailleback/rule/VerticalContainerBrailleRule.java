...
class VerticalContainerBrailleRule implements BrailleRule {
    private final String TAG="VerticalContainerBrailleRule";
    @Override
    ...
    public void format(Editable result,
        ...
        Log.d(TAG,"format called on node : "+node.getText());
        ...
        String s =context.getString(res);
        Log.d(TAG,"result appended with "+s);
        result.append(s);
