...
public class LabelProvider extends ContentProvider {
    ...
    public static final Uri LABELS_CONTENT_URI = new Uri.Builder()
            .scheme("content")
            .authority(AUTHORITY)
            .path(LABELS_PATH)
            .build();
    private static final Uri LABELS_ID_CONTENT_URI = Uri.withAppendedPath(LABELS_CONTENT_URI, "#");
    public static final String PACKAGE_SUMMARY_PATH = "packageSummary";
    public static final Uri PACKAGE_SUMMARY_URI = new Uri.Builder()
            .scheme("content")
            .authority(AUTHORITY)
    ...
    public static final int LABELS_ID = 2;
    public static final int PACKAGE_SUMMARY = 3;
